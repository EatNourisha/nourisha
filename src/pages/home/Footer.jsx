    ...
    <footer>
        ...
        <div className="fourth">
            ...
            <div className="facebook">
                <a href="https://web.facebook.com/people/Eatnourisha/100068259570536/?mibextid=LQQJ4d" target="_blank">
                <img src={facebook} alt="facebook" />
                </a>
            </div>
            <div className="twitter">
                <a href="https://twitter.com/nourisha12/status/1652961343736086529?s=46" target="_blank">
                <img src={twitter} alt="twitter" />
                </a>
            </div>
            <div className="instagram">
                <a href="https://www.instagram.com/eatnourisha/?igshid=MmJiY2I4NDBkZg==" target="_blank">
