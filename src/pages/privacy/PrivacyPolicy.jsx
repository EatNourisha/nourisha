      ...
      <div className="container container-privacy">
        <div className="who">
          ...
          <p>
            ...
            company registered in England and Wales with whose registered office
            is at 71-75 Shelton Street, Covent Garden, London, United Kingdom,
            WC2H 9JQ. All references to “Nourisha”, “us” or “we” throughout this
            statement is to the business in the House of Nourisha who you are
            dealing with.
          </p>
          <p>
            ...
            on these terms or the service that we provide.
          </p>
        </div>
        <div className="what">
          <h2>What information we hold about you</h2>
          <p>
            We collect personal information whenever you provide it to us. This
        ...
        <div className="how-we">
          ...
          <ul>
            ...
            <li>
              ...
              in order to establish your financial suitability for our training
              services;
            </li>
          ...
          <p>
            ...
            whereby certain information may be automatically collected from your
            device. Collecting this information enables us to better understand
            our website visitors and what content on our website is of interest
            to them. We use this information for our internal analytics purposes
            and to improve the quality and relevance of our website to our
            visitors. The cookies collect information in a way that does not
            directly identify anyone. For more information, view our cookie
            policy.
          </p>
        </div>
        <div className="who-we">
          ...
          <ul>
            ...
            <li>
              sponsors who have funded studies regarding results and attendance
              only.
            </li>
          </ul>
        </div>
        <div className="keeping">
          ...
          <p>
            ...
            personal data, for example we store your personal data on secure
            servers and ensure access to your personal data is limited to
            authenticated and approved staff.
          </p>
          <p>
            ...
            integrity of any personal data that are transferred from you or to
        ...
        <div className="cookies">
          <h2>Cookies</h2>
          <p>
            We use cookies and similar tracking technology on our websites which
            enable us to collect statistical data about your use of our website.
            This enables us to enhance and develop our website to improve your
            use of it. For more information on the cookies which we utilise on
            our website please refer to our cookies policy.
          </p>
          <p>
        ...
        <div className="transfer">
          ...
          <p>
            ...
            up-to-date information issued on GDPR. This includes all information
            available at the <strong>UK Government website</strong> and the{" "}
          ...
          <p>
            ...
            personal data as you enjoy under English law. We will take all steps
            reasonably necessary to ensure that your data is treated securely
            and in accordance with this privacy statement and data protection
            legislation.{" "}
          </p>
          <p>
        ...
        <div className="retention">
          ...
          <p>
            We will retain your information for no longer than is necessary for
            the purposes for which we collected it, or for as long as we have
            your consent to do so where your consent is our legal basis on which
            we process such data. All retained data will be held subject to this
            policy.
          </p>
        </div>
        <div className="changes">
          ...
          <p>
            ...
            that will apply each time you interact with us.
          </p>
        </div>
        <div className="cont">
          <h2>Contact Us</h2>
