    ...
    <div className="terms-and-conditions">
      <div className="container container-terms">
        <div className="definitions">
          <h1>1. Definitions</h1>
          <h2>Content</h2>
          <p>The information and materials appearing on the Site</p>
          <h2>Terms</h2>
          <p>
            The conditions set out in this document including Our Privacy Policy
          </p>
          <h2>Site</h2>
          <p>https://eatnourisha.com/</p>
          <h2>We/Us/Our</h2>
          <p>
          ...
          <h2>You/Your</h2>
          <p>The person company or party who uses Our Site</p>
        </div>
        <div className="general">
          ...
          <ul>
            ...
            <li>
              2.2 These Terms constitute the entire agreement between You and Us
              and govern Your use of the Site superseding any prior agreements
              between You and Us
            </li>
            <li>
              ...
              use of the Site and therefore acceptance of these Terms
            </li>
            <li>
            ...
            <li>
              2.5 Where We collect information from You via Your access and use
              of the Site and You voluntarily submit to Us such information
              whilst using the Site Our use of Your information will be governed
              by these Terms in accordance with our Privacy Statement. Please
              read these Terms and our privacy statement carefully before using
              the Site
            </li>
            <li>
              2.6 If You do not agree to all of these Terms You may not use the
              Site which is owned and operated by Us
            </li>
            <li>
              2.7 If You have any comments suggestions or questions about these
              Terms and/or the Site and/or Us generally You can contact Us by
              sending an e-mail to help@eatnourisha.com or by writing to House
              of Nourisha Ltd at the address above.
            </li>
          </ul>
        </div>
        <div className="copyright">
          <h1>3. Copyright and trademarks</h1>
          <ul>
            <li>
            ...
            <li>
              3.2 All software used on the Site and all Content included on the
              Site (including without limitation site design text graphics audio
              and video the selection and arrangement thereof and the underlying
              source code) is Our property or that of Our suppliers and is
            ...
            <li>
              ...
              republished posted transmitted stored sold or distributed without
              the prior written permission of the copyright holder. This
              excludes the downloading of one copy of extracts from the Site on
              any single computer for personal non-commercial home use only
              provided that all copyright and proprietary notices are kept
              intact
            </li>
            <li>
            ...
            <li>
              3.7 Requests to republish any of the Content and to use quotations
              or extracts from the Site should be addressed to
              help@eatnourisha.com
            </li>
            <li>
              3.8 We have made every effort to secure where appropriate licenses
              and clearances for all third party intellectual property used on
              the Site. You may notify Us of alleged intellectual property
              rights infringement by contacting us via e-mail at
              help@eatnourisha.com
            </li>
          </ul>
        </div>
        <div className="links">
          ...
          <ul>
            ...
            <li>
              4.2 We have not reviewed all of these third party websites and do
              not make any representations regarding the availability or content
              or accuracy of materials on such websites. If You decide to access
              third party websites through links on the Site You do so at your
              own risk. Your use of third party websites is subject to the terms
              and conditions of use of those websites
            </li>
          </ul>
        </div>
        <div className="liability">
          <h1>5. Liability disclaimer</h1>
          <ul>
            <li>
              5.1 While we endeavour to ensure that the information on the Site
              is correct to the maximum extent permitted by law We provide You
              with the Site on an ‘as is’ basis only
            </li>
            <li>
              5.2 You accept that access to the Site may be suspended at any
              time and without notice in the case of systems failure maintenance
              or repair or for any other reasons whatsoever including for
              reasons beyond Our control
            </li>
            <li>
              5.3 We make no representation or warranties of any kind express or
              ...
              available on the Site or that the use of the Site will be
            ...
            <li>
              5.5 Any other party whether or not involved in creating producing
              maintaining or delivering the Site including the officers
              employees consultants or agents exclude all liability and
              responsibility for any amount or kind of loss or damage that may
              result to You or any third party including without limitation any
              ...
              interpretation and whether in tort including without negligence
              contract warranty or otherwise in connection with the Site in any
              way or in connection with the use inability to use or the results
              of use of the Site any websites linked to the Site or the Content
              on the Site including but not limited to loss or damage due to
              viruses including logic bombs trojan horses worms harmful
              components corrupted data or other malicious software or harmful
              data that may infect Your computer equipment software data or
              other property on account of Your access to use of or browsing the
              Site or Your downloading of any content from the Site or any
            ...
            <li>
              ...
              applicable law including conditions and warranties as to title to
              goods implied by sale of goods legislation and where the customer
              deals as a consumer or conditions as to goods’ description fitness
              and quality and implied by sale of goods legislation and
              conditions as to supply of goods and services legislation
            </li>
            <li>
              5.8 If Your use of the content on the Site results in the need for
              servicing repairing or correction of equipment software or data
              You assume all costs thereof
            </li>
            <li>
              5.9 If You are a consumer this legal notice does not affect the
              legal rights which You have under law which cannot be excluded or
              limited. If You want to know what these rights are You should
        ...
        <div className="your">
          ...
          <ul>
            <li>
              6.1 If from time to time We offer and You have an account with Us
              then You are responsible for maintaining the confidentiality of
              this account and any related passwords for Your restricting access
            ...
            <li>
              6.2 Other than personal data or sensitive personal data about You
              which is covered under the terms of our Privacy Policy any
            ...
            <li>
              6.3 We and designated third parties shall be free to copy disclose
              distribute incorporate and otherwise use such material and all
              data images sounds text and other things embodied therein for any
              and all commercial or non-commercial purposes
            </li>
            <li>
              6.4 In accordance with and without prejudice to our Acceptable Use
              Policy You are prohibited from posting or transmitting to or from
            ...
            <li>
              ...
              third party in the United Kingdom or any other country in the
              world or
            </li>
            <li>
            ...
            <li>
              6.5 We shall fully co-operate with any law enforcement authorities
              or court order requesting or directing us to disclose the identity
              or locate anyone posting any material in breach of the above
              prohibitions
            </li>
          </ul>
        </div>
        ...
        <div className="advert">
          <h1>8. Advertisements</h1>
          <ul>
            <li>
              8.1 The Site may contain advertisements by third parties and these
              advertisements may contain links to other websites
            </li>
            <li>
        ...
        <div className="competitions">
          <h1>9. Competitions and Prizedraws</h1>
          <p>
        ...
        <div className="indemnity">
          ...
          <ul>
            <li>
              ...
              resulting from or alleged to result from Your use of the Content
              of the Site in a manner that violates or is alleged to violate
              these Terms
            </li>
            <li>
        ...
        <div className="force">
          ...
          <p>
            ...
            reasonable control including but not limited to failure of equipment
            or communication lines telephone or other interconnect problems
            computer viruses including logic bombs Trojan horses worms harmful
            components corrupted data or other malicious software or harmful
            data unauthorised access theft operator errors severe weather
            earthquakes or natural disasters strikes or other labour problems
            wars or governmental restrictions
          </p>
        </div>
        <div className="severe">
          <h1>12. Severability and waiver</h1>
          <p>
        ...
        <div className="access">
          <h1>13. Access outside England</h1>
          <ul>
            <li>
            ...
            <li>
              13.2 If You access the Site from outside England You do so at Your
        ...
        <div className="juris">
          <h1>14. Jurisdiction</h1>
          <p>
            These Terms are governed by and construed in accordance with English
            Law unless You live in Scotland in which case these Terms will be
            governed by Scots Law and You and We irrevocably agree that the UK
            Courts shall have non-exclusive jurisdiction to settle any dispute
            which may arise out of or in connection with these Terms or the
            legal relationship established by them and for those purposes
            irrevocably submit all disputes to the non-exclusive jurisdiction of
            the UK Courts
          </p>
        </div>
        <div className="notification">
          <h1>Notification of changes to these terms</h1>
          <ul>
            <li>
            ...
            <li>
              ...
              and You will be deemed to have accepted any change if You continue
              to access the Site after that time
            </li>
          </ul>
        </div>
